  ...
  static ThemeData get darkTheme {
    return ThemeData.dark().copyWith(
      ...
      textTheme: const TextTheme(
        titleLarge: TextStyle(color: textColorPrimary, fontSize: 22, fontWeight: FontWeight.bold),
        titleMedium: TextStyle(color: textColorPrimary, fontSize: 18, fontWeight: FontWeight.w500),
        titleSmall: TextStyle(color: textColorPrimary, fontSize: 16, fontWeight: FontWeight.w500),
